...
enum HardwareCatalog {
    ...
    static let motherboards: [HardwareCatalogItem] = [
        ...
        HardwareCatalogItem(id: "asus-b860-a-gaming", name: "ROG STRIX B860-A GAMING WIFI S吹雪", brand: "华硕", detail: "Intel · LGA1851 · B860"),
        HardwareCatalogItem(id: "asus-b860-g-gaming", name: "ROG STRIX B860-G GAMING WIFI S小吹雪", brand: "华硕", detail: "Intel · LGA1851 · B860"),
        ...
        HardwareCatalogItem(id: "msi-z890-edge-ti", name: "MPG Z890 EDGE TI WIFI 刀锋 钛", brand: "微星", detail: "Intel · LGA1851 · Z890"),
        ...
        HardwareCatalogItem(id: "asus-z890-a-gaming", name: "ROG STRIX Z890-A GAMING WIFI S 吹雪", brand: "华硕", detail: "Intel · LGA1851 · Z890"),
        ...
        HardwareCatalogItem(id: "msi-b760m-project-zero", name: "B760M PROJECT ZERO 零", brand: "微星", detail: "Intel · LGA1700 · B760"),
        ...
        HardwareCatalogItem(id: "asus-b760-a-wifi", name: "ROG STRIX B760-A GAMING WIFI 吹雪", brand: "华硕", detail: "Intel · LGA1700 · B760"),
        HardwareCatalogItem(id: "asus-b760-a-wifi-d4", name: "ROG STRIX B760-A GAMING WIFI D4 吹雪", brand: "华硕", detail: "Intel · LGA1700 · B760"),
        ...
        HardwareCatalogItem(id: "asus-b760-btf-wifi", name: "TX GAMING B760-BTF WIFI 天选背置主板", brand: "华硕", detail: "Intel · LGA1700 · B760"),
        ...
        HardwareCatalogItem(id: "msi-z790-edge-wifi-d4", name: "MPG Z790 EDGE WIFI DDR4 刀锋", brand: "微星", detail: "Intel · LGA1700 · Z790"),
        HardwareCatalogItem(id: "msi-z790i-edge-wifi", name: "MPG Z790I EDGE WIFI 刀锋", brand: "微星", detail: "Intel · LGA1700 · Z790"),
        ...
        HardwareCatalogItem(id: "asus-z790-hero-eva", name: "ROG MAXIMUS Z790 HERO EVA-02 新世纪福音战士限量版", brand: "华硕", detail: "Intel · LGA1700 · Z790"),
        HardwareCatalogItem(id: "asus-z790-a-gaming", name: "ROG STRIX Z790-A GAMING WIFI吹雪", brand: "华硕", detail: "Intel · LGA1700 · Z790"),
        HardwareCatalogItem(id: "asus-z790-a-gaming-s", name: "ROG STRIX Z790-A GAMING WIFI S 吹雪", brand: "华硕", detail: "Intel · LGA1700 · Z790"),
        ...
        HardwareCatalogItem(id: "msi-b850-edge-ti", name: "MPG B850 EDGE TI WIFI 刀锋 钛", brand: "微星", detail: "AMD · AM5 · B850M"),
        ...
        HardwareCatalogItem(id: "asus-b850-g-chuixue", name: "ROG STRIX B850-G GAMING WIFI S 小吹雪", brand: "华硕", detail: "AMD · AM5 · B850M"),
        ...
        HardwareCatalogItem(id: "msi-x870e-godlike", name: "MEG X870E GODLIKE 超神", brand: "微星", detail: "AMD · AM5 · X870E"),
        HardwareCatalogItem(id: "msi-x870e-godlike-max", name: "MEG X870E GODLIKE MAX 超神", brand: "微星", detail: "AMD · AM5 · X870E"),
        ...
        HardwareCatalogItem(id: "asus-b650m-tuf", name: "TUF GAMING B650M-PLUS重炮手", brand: "华硕", detail: "AMD · AM5 · B650"),
        ...
        HardwareCatalogItem(id: "msi-b560-torpedo", name: "MAG B560 TORPEDO 鱼雷", brand: "微星", detail: "Intel · LGA1200 · B560"),
        ...
        HardwareCatalogItem(id: "msi-z590-tomahawk", name: "MAG Z590 TOMAHAWK WIFI 战斧导弹", brand: "微星", detail: "Intel · LGA1200 · Z590"),
        ...
        HardwareCatalogItem(id: "msi-z590i-unify", name: "MEG Z590I UNIFY 暗影", brand: "微星", detail: "Intel · LGA1200 · Z590"),
        HardwareCatalogItem(id: "msi-z590-carbon-ek", name: "MPG Z590 CARBON EK X (水冷定制版)", brand: "微星", detail: "Intel · LGA1200 · Z590"),
        HardwareCatalogItem(id: "msi-z590-carbon-wifi", name: "MPG Z590 GAMING CARBON WIFI 暗黑", brand: "微星", detail: "Intel · LGA1200 · Z590"),
        HardwareCatalogItem(id: "msi-z590-edge-wifi", name: "MPG Z590 GAMING EDGE WIFI (刀锋)", brand: "微星", detail: "Intel · LGA1200 · Z590"),
        HardwareCatalogItem(id: "msi-z590-gaming-plus", name: "MPG Z590 GAMING PLUS 电竞板", brand: "微星", detail: "Intel · LGA1200 · Z590"),
        ...
        HardwareCatalogItem(id: "msi-z690-edge-ti-wifi", name: "MPG Z690 EDGE TI WIFI 刀锋 钛", brand: "微星", detail: "Intel · LGA1700 · Z690"),
    ...
    static func motherboardSocket(for motherboard: String) -> String? {
        let canonicalName = canonicalMotherboardName(for: motherboard)
        guard let item = motherboards.first(where: { $0.name == canonicalName }) else { return nil }
        return socket(from: item.detail)
    }

    static func canonicalMotherboardName(for motherboard: String) -> String {
        motherboardNameAliases[motherboard] ?? motherboard
    }
    ...
    private static let motherboardNameAliases: [String: String] = [
        "ROG STRIX B860-A GAMING WIFI": "ROG STRIX B860-A GAMING WIFI S吹雪",
        "ROG STRIX B860-G GAMING WIFI": "ROG STRIX B860-G GAMING WIFI S小吹雪",
        "MAG Z890 TOMAHAWK WIFI (战斧导弹)": "MAG Z890 TOMAHAWK WIFI 战斧导弹",
        "MEG Z890 GODLIKE (超神)": "MEG Z890 GODLIKE 超神",
        "MEG Z890 UNIFY-X (暗影)": "MEG Z890 UNIFY-X 暗影",
        "MPG Z890 EDGE TI WIFI (刀锋钛)": "MPG Z890 EDGE TI WIFI 刀锋 钛",
        "ROG STRIX Z890-A GAMING WIFI": "ROG STRIX Z890-A GAMING WIFI S 吹雪",
        "B760M PROJECT ZERO": "B760M PROJECT ZERO 零",
        "ROG STRIX B760-A GAMING WIFI": "ROG STRIX B760-A GAMING WIFI 吹雪",
        "ROG STRIX B760-A GAMING WIFI D4": "ROG STRIX B760-A GAMING WIFI D4 吹雪",
        "TX GAMING B760-BTF WIFI (天选)": "TX GAMING B760-BTF WIFI 天选背置主板",
        "H610M BOMBER DDR4 (爆破弹)": "H610M BOMBER DDR4 爆破弹",
        "MPG Z790 EDGE WIFI DDR4": "MPG Z790 EDGE WIFI DDR4 刀锋",
        "MPG Z790I EDGE WIFI (ITX)": "MPG Z790I EDGE WIFI 刀锋",
        "ROG MAXIMUS Z790 HERO EVA-02 EDITION": "ROG MAXIMUS Z790 HERO EVA-02 新世纪福音战士限量版",
        "ROG STRIX Z790-A GAMING WIFI": "ROG STRIX Z790-A GAMING WIFI吹雪",
        "ROG STRIX Z790-A GAMING WIFI S": "ROG STRIX Z790-A GAMING WIFI S 吹雪",
        "MAG B850M MORTAR (迫击炮)": "MAG B850M MORTAR 迫击炮",
        "MAG B850M MORTAR WIFI (迫击炮)": "MAG B850M MORTAR WIFI 迫击炮",
        "MPG B850 EDGE TI WIFI": "MPG B850 EDGE TI WIFI 刀锋 钛",
        "ROG STRIX B850-G GAMING WIFI (小吹雪)": "ROG STRIX B850-G GAMING WIFI S 小吹雪",
        "MAG X870E TOMAHAWK WIFI (战斧导弹)": "MAG X870E TOMAHAWK WIFI 战斧导弹",
        "MEG X870E GODLIKE": "MEG X870E GODLIKE 超神",
        "MEG X870E GODLIKE MAX": "MEG X870E GODLIKE MAX 超神",
        "MPG X870E CARBON WIFI (暗黑)": "MPG X870E CARBON WIFI 暗黑",
        "MAG B650M MORTAR (迫击炮)": "MAG B650M MORTAR 迫击炮",
        "TUF GAMING B650M-PLUS 重炮手": "TUF GAMING B650M-PLUS重炮手",
        "MEG X670E ACE (战神)": "MEG X670E ACE 战神",
        "MEG X670E GODLIKE (超神)": "MEG X670E GODLIKE 超神",
        "MPG X670E CARBON WIFI (暗黑)": "MPG X670E CARBON WIFI 暗黑",
        "ROG STRIX X670E-A GAMING WIFI (吹雪)": "ROG STRIX X670E-A GAMING WIFI 吹雪",
        "MAG B560 TORPEDO": "MAG B560 TORPEDO 鱼雷",
        "MAG Z590 TOMAHAWK WIFI (战斧)": "MAG Z590 TOMAHAWK WIFI 战斧导弹",
        "MAG Z590 TORPEDO (鱼雷)": "MAG Z590 TORPEDO 鱼雷",
        "MEG Z590 ACE (战神)": "MEG Z590 ACE 战神",
        "MEG Z590 GODLIKE (超神)": "MEG Z590 GODLIKE 超神",
        "MEG Z590 UNIFY (暗影)": "MEG Z590 UNIFY 暗影",
        "MEG Z590I UNIFY (ITX 迷你板)": "MEG Z590I UNIFY 暗影",
        "MPG Z590 GAMING CARBON WIFI (暗黑板)": "MPG Z590 GAMING CARBON WIFI 暗黑",
        "MPG Z590 GAMING PLUS": "MPG Z590 GAMING PLUS 电竞板",
        "MPG Z690 EDGE TI WIFI": "MPG Z690 EDGE TI WIFI 刀锋 钛",
    ]
